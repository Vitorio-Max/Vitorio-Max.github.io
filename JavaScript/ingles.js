...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const words = [
        { word: "apple", image: "../Imagenes/english_game/apple.png", sound: "../Sonidos/english_game/apple.mp3" },
        { word: "cat", image: "../Imagenes/english_game/cat.png", sound: "../Sonidos/english_game/cat.mp3" },
        { word: "dog", image: "../Imagenes/english_game/dog.png", sound: "../Sonidos/english_game/dog.mp3" },
        { word: "ball", image: "../Imagenes/english_game/ball.png", sound: "../Sonidos/english_game/ball.mp3" },
        { word: "car", image: "../Imagenes/english_game/car.png", sound: "../Sonidos/english_game/car.mp3" },
        { word: "bird", image: "../Imagenes/english_game/bird.png", sound: "../Sonidos/english_game/bird.mp3" },
        { word: "house", image: "../Imagenes/english_game/house.png", sound: "../Sonidos/english_game/house.mp3" },
        { word: "tree", image: "../Imagenes/english_game/tree.png", sound: "../Sonidos/english_game/tree.mp3" },
        { word: "sun", image: "../Imagenes/english_game/sun.png", sound: "../Sonidos/english_game/sun.mp3" },
        { word: "flower", image: "../Imagenes/english_game/flower.png", sound: "../Sonidos/english_game/flower.mp3" },
    ];
